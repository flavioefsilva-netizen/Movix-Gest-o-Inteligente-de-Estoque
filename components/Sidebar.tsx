          ...
          <div className="p-4 bg-gray-50 border-b border-gray-200 flex items-center gap-3 w-full shrink-0">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[9px] font-extrabold text-slate-700 bg-slate-200/50 px-1 rounded-sm leading-none py-0.5">V 3.2</span>
              </div>
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 flex flex-col w-72 bg-gray-100 text-gray-800 h-screen overflow-y-auto border-r border-gray-250 shadow-2xl transition-transform duration-300 md:sticky md:top-0 md:translate-x-0 md:z-0 md:shadow-none md:flex ${
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[9px] font-extrabold text-blue-700 bg-blue-50 border border-blue-200 px-1 rounded-sm leading-none py-0.5">V 3.2</span>
          </div>
          ...
          {isActionsOpen && (
            <div className="space-y-1 mt-2.5">
              {[
                ...
                { id: 'lancar_saida', label: 'Lançar Saída', icon: 'outbox' },
                ...
                const isLocked = isInventoryLocked && (act.id === 'criar_transporte' || act.id === 'lancar_saida' || act.id === 'conferencia');
                return (
                  <button
                    key={act.id}
                    disabled={isLocked}
